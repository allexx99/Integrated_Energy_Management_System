...
//   const [users, setUsers] = useState([]); // Add this state for the list of users
...
//   //   if (stompClient) {
//   //     var chatMessage = {
//   //       senderName: userDataObj.username,
...
//       <h3>Connected as {localStorage.getItem("username")}</h3>
...
//             <li
//               onClick={() => {
//                 // setUserData({ ...userData, receivername: user.username });
//                 // setUserData({ currentUser, receivername: user.username });
//                 userDataObj.username = currentUser;
//                 userDataObj.receivername = user.username;
//                 localStorage.setItem("userData", JSON.stringify(userDataObj));
//                 setTab(user.username);
//                 // connect(user.username); // Always connect when a user is selected
//               }}
...
//               {privateChats.has(tab) && Array.isArray(privateChats.get(tab)) ? (
//         privateChats.get(tab).map((chat, index) => (
//                 <li
//                   className={`message ${
//                     chat.senderName === userData.username && "self"
